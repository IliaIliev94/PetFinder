...
using static PetFinder.Data.DataConstraints.User;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToPage("RegisterConfirmation", new { userName = this.Input.UserName, email = this.Input.Email, returnUrl = returnUrl });
                    }
                    else
                    {
